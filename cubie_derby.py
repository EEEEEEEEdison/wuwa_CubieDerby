...
# Pure dataclass types live in cubie_derby_core/race_types.py; the
# names below are explicit re-exports so existing `from cubie_derby
# import RaceConfig` callers (notably tests/_shared.py) keep working.
from cubie_derby_core.race_types import (  # noqa: E402  (intentional late re-export)
    RaceConfig,
    RaceMovementState,
    RaceResult,
    RaceSkillState,
...
# --- end of moved dataclass block (see cubie_derby_core/race_types.py) ---
